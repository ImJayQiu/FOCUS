...
class ForecastController < ApplicationController
	...
	@missing_models = params[:missing_models]
	if @missing_models.nil?
	    @models = @selected_models
	else
	    @models = @selected_models - @missing_models.split(" ")
	end
	...
	@sdy = params[:sdy]
	@edy = params[:edy]
	@missing_years = params[:missing_years]
	if @missing_years.nil?
	    @selected_years = (@sdy..@edy).to_a 
	else
	    @selected_years = (@sdy..@edy).to_a - @missing_years.split(" ")
	end
	...
	@method_all = Fmethod.find(@method_ids)
...
=end
	    ...
	    @selected_years.to_a.each do |year|
		...
		@selected_years.to_a.append(@ic_year).each do |year|
